...
expense = between(expense, '### A4\\. 法务合规', '### A\\. 开发费合计');
...
expense = expense.replace(
  /\| \*\*A\. 开发费（现金）\*\* \| \*\*¥165,600\*\*[\s\S]*?\| 含设计、法务；人力自研不计入 \|/,
  '| **A. 开发费（现金）** | **¥108,000** | ¥80,500 – ¥107,000 | 含设计；人力自研不计入 |',
);
expense = expense.replace(
  /\| \*\*合计\*\* \| \*\*¥349,920\*\*[\s\S]*?\| 首年技术与基础设施现金支出 \|/,
...
expense = expense.replace(
  /\| \*\*开发费现金合计\*\* \| \*\*¥165,600\*\* \| \*\*¥88,500 – ¥221,000\*\* \|/,
