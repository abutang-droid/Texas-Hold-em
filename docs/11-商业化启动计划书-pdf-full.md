...
| 增长 | 创始人兼 | 小预算投放（T1 三国） |
| 客服 | 外包或工具 | 工单、退款协助 |
| 设计（商店素材） | 外包一次性 | App Store / Google Play 截图、预览视频 |
| **UI / UX 设计** | **外包一次性** | **App 内界面：大厅、牌桌、商城、弹窗；Figma + 切图标注** |
...
> **已采用创始人自研版预算**（v1.4）  
> 全年现金硬顶：**¥554,400**（已剔除法务合规 ¥57,600）（较 v1.3 **+¥72,000** APP UI 设计）；研发外包节省 **¥115,200** 已转投买量  
> 汇率：1 USD = 7.20 CNY
...
| 期次 | 计划时间 | 功能交付物 | 验收标准 | 付款金额 | 累计已付 |
|------|----------|------------|----------|----------|----------|
| **第一期** | **W1 – W2** | Design Token；大厅 / 商城 / 设置 / 引导页高保真 | 设计规范 + 核心页评审通过 | **¥28,800** | ¥28,800 |
| **第二期** | **W3 – W4** | 9 人牌桌 UI；私人场 / 弹窗 / 空状态；切图标注 + 资源包 | 牌桌 UI + Redline 交付完整 | **¥32,400** | ¥61,200 |
| **第三期** | **W5 – W8**（至 W12） | 开发联调修订 1 轮；公测反馈迭代 ≤2 轮；源文件归档 | 创始人终验签字 | **¥10,800** | **¥72,000** |

> 付款节点：每期验收通过后 **3 个工作日内**支付。
...
| 类别 | 外包版 | 自研版（v1.3） | 自研版（v1.4 · 当前） | 差额 |
|------|--------|----------------|----------------------|------|
...
| 周次 | 里程碑 | 交付物 | 预算消耗 |
|------|--------|--------|----------|
| W1–W2 | 真机 IAP 联调 + **UI 第一期** | iOS / Android 生产验单 E2E；Design Token + 核心页 UI | 创始人自研 + **¥28,800** |
| W2–W3 | 生产环境部署 | IAP 凭证、监控告警 | 创始人自研 |
| W3–W4 | 压测 + **UI 第二期** | 300 CCU 报告；牌桌 UI + 切图标注包 | 创始人自研 + **¥32,400** |
| W3–W4 | 埋点上线 | 注册→充值漏斗 | 创始人自研 |
| W4–W5 | 商店素材 + UI 开发联调 | 英文截图、30s 视频；Redline 对接开发 | ¥15,000 |
| W5–W8 | **UI 第三期**（公测前） | 联调修订 + 终验 | **¥10,800** |
...
| P0 | 委托 APP UI/UX 设计（签三期合同） | 外包 | W1 | 合同总额 ¥72,000 |
| P0 | UI 设计第一期：Design Token + 核心页 | 外包 | W1–W2 | **¥28,800** |
| P0 | UI 设计第二期：牌桌 + 弹窗 + 切图包 | 外包 | W3–W4 | **¥32,400** |
| P0 | 英文商店截图 + 预览视频 | 设计 | W4–W5 | ¥6,500 – ¥18,000 |
| P0 | 私人场公测回归测试 | **创始人** | W6 | — |
| P0 | 全球英文区提审 | 创始人 | W7 | — |
| P1 | UI 设计第三期：联调修订 + 公测迭代 | 外包 | W5–W12 | **¥10,800** |
...
#### A4.1 三期付款计划（按功能交付 · ¥72,000）

> 付款节点：**每期交付物验收通过后 3 个工作日内**支付；第三期含公测迭代，最晚 **W12** 前结清。

| 期次 | 计划时间 | 功能交付物 | 验收标准 | 付款金额 | 累计已付 |
|------|----------|------------|----------|----------|----------|
| **第一期** | **W1 – W2** | ① Design Token（色彩 / 字体 / 筹码·卡牌样式）<br>② 核心页面高保真：大厅、商城、设置、引导页 | Figma 源文件 + 设计规范评审通过 | **¥28,800** | ¥28,800 |
| **第二期** | **W3 – W4** | ① 9 人牌桌 UI（下注区、公共牌、座位、筹码堆）<br>② 私人场 / 弹窗 / 空状态（开房、破产、首充、举报等）<br>③ 切图标注 + @1x/@2x/@3x 资源包 | 牌桌 UI 评审通过；Redline 与切图包交付完整 | **¥32,400** | ¥61,200 |
| **第三期** | **W5 – W8**（公测后至 **W12**） | ① 开发联调视觉修订 **1 轮**<br>② 公测用户反馈 UI 迭代 **≤2 轮**<br>③ Figma 源文件归档移交 | 创始人终验签字；无 P0 视觉阻塞项 | **¥10,800** | **¥72,000** |

| 付款节奏摘要 | 金额 | 对应周次 |
|-------------|------|----------|
| 第一期 | ¥28,800（40%） | W2 末 |
| 第二期 | ¥32,400（45%） | W4 末 |
| 第三期 | ¥10,800（15%） | W8 – W12 |
| **合计** | **¥72,000** | |
...
*本清单为 `docs/11-商业化启动计划书.md` v1.4 的费用拆分附录；报价以实际签约 / 账单为准。*
